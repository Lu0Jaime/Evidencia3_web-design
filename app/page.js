...
import { IconDashboard, IconBell, IconUsers, IconCheck } from '@/components/Icons'
...
async function getDashboardData() {
  try {
    ...
    const enriched = (obligs || [])
      .map(o => ({ ...o, _ev: calcEstatus(o.fecha_vencimiento) }))
      .filter(o => o._ev.label !== 'Al día')

    let proximas = 0, vencidas = 0
    for (const a of enriched) {
      if (a._ev.label === 'Próximo a vencer') proximas++
      else if (a._ev.label === 'Vencido') vencidas++
    }
    const alerts = enriched.slice(0, 6)
  ...
  return (
    <div className="page-wrap">
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          <div className="stat-label">Próx. a Vencer</div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16 }}>
        ...
        <div className="card">
          ...
          <div style={{ padding: 0 }}>
            {dash.alerts.length === 0 ? (
              <div className="empty">
                <div className="empty-icon"><IconCheck size={32} /></div>
        ...
        <div className="card">
          ...
          <div style={{ padding: 0 }}>
            {recientes.length === 0 ? (
              <div className="empty">
                <div className="empty-icon"><IconUsers size={32} /></div>
